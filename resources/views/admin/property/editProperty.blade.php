                            ...
                            <div class="col-xxl-6 col-lg-6">
                              <div class="form-group">
                                ...
                                <select class="form-control" data-plugin="select2" name="typeProperty">
                                      <option value="{{$Property->typeProperty}}">{{$Property->typeProperty}}</option>
                          ...
                          <div class="row">
                            ...
                            <div class="col-xxl-6 col-lg-6">
                              <div class="form-group">
                                ...
                                <input type="text" class="form-control" id="inputPasswordOne" name="neighborhood" value="{{$Property->neighborhood}}" required="required">
                              </div>
                            </div>
                          </div>
                          <div class="row">
                            <div class="col-xxl-6 col-lg-6">
                              <div class="form-group">
                                ...
                                <input type="text" class="form-control" id="inputPasswordOne" name="address" value="{{$Property->address}}" required="required">
                              </div>
                            </div>
                            <div class="col-xxl-6 col-lg-6">
                              <div class="form-group">
                                <label class="form-control-label" for="inputPasswordOne">Precio ($)</label>
                                <input type="text" class="form-control" id="inputPasswordOne" name="price" value="{{$Property->price}}" required="required">
                              </div>
                            </div>
                          </div>
                          <div class="row">
                            <div class="col-xxl-6 col-lg-6">
                              <div class="form-group">
                                ...
                                <select class="form-control" data-plugin="select2" name="stratum">
                                      <option value="{{$Property->stratum}}">{{$Property->stratum}}</option>
                            ...
                            <div class="col-xxl-6 col-lg-6">
                              <div class="form-group">
                                ...
                                <input type="text" class="form-control" id="inputPasswordOne" name="area" value="{{$Property->area}}" required="required">
                              </div>
                            </div>
                          </div>
                          <div class="row">
                            <div class="col-xxl-6 col-lg-6">
                              <div class="form-group">
                                ...
                                <select class="form-control" data-plugin="select2" name="rooms">
                                      <option value="{{$Property->rooms}}">{{$Property->rooms}}</option>
                                      <option value="1">1</option>
                                      <option value="2">2</option>
                                      <option value="3">3</option>
                                      <option value="4">4</option>
                          ...
                          <div class="row">
                            <div class="col-xxl-12 col-lg-12">
                              <div class="form-group">
                                ...
                                <textarea class="form-control" placeholder="" name="characteristics">{{$Property->characteristics}}</textarea>
                              </div>
                            </div>
                          </div>
