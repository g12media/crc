    ...
    <div class="page">
            ...
            <div class="card card-shadow text-center">
              ...
              <div class="card-footer">
                <div class="row no-space">
                  <div class="col-6">
                    <strong class="profile-stat-count">{{$CountProperty}}</strong>
                    <span>Inmuebles</span>
                  </div>
                  <div class="col-6">
          ...
          <div class="col-lg-8">
            <!-- Panel -->
                ...
                <header class="panel-heading">
                  <div class="panel-actions"><button type="button" onclick="window.location.href='/administrator/properties/profile/edit/{{Crypt::encrypt($user->id)}}'" class="btn btn-floating btn-success btn-sm"><i class="icon wb-pencil" aria-hidden="true"></i></button></div>
                </header>
      ...
      <div class="page-content container-fluid pt-0">
        ...
        <header class="panel-heading">
          ...
          <div class="panel-actions"><button type="button" onclick="window.location.href='/administrator/properties/profile/add/{{Crypt::encrypt($user->id)}}'" class="btn btn-floating btn-success btn-sm"><i class="icon io-plus" aria-hidden="true"></i></button></div>
        </header>
        <div class="panel-body">
          <div class="row">
            <div class="col-lg-12">
                ...
                <table class="table table-hover dataTable table-striped w-full" data-plugin="dataTable">
                  ...
                  <tbody>
                    ...
                    <tr>
                      ...
                      <td>Arriendo</td>
                      @endif
                      <td>{{$p->typeProperty}}</td>
                      <td>{{$p->city}}</td>
                      <td>{{$p->neighborhood}}</td>
                      <td>${{$p->price}}</td>
                      <td><button onclick="window.location.href='/administrator/properties/details/{{Crypt::encrypt($p->id)}}'" type="button" class="btn btn-raised btn-primary">Detalles</button></td>
                    </tr>
                    @endforeach
                  </tbody>
                </table>
