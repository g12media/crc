...
<link rel="stylesheet" href="{{URL::asset('admin/global/vendor/datatables.net-select-bs4/dataTables.select.bootstrap4.css')}}">
    ...
    <link rel="stylesheet" href="{{URL::asset('admin/global/vendor/owl-carousel/owl.carousel.css')}}">
    <link rel="stylesheet" href="{{URL::asset('admin/global/vendor/slick-carousel/slick.css')}}">
    <link rel="stylesheet" href="{{URL::asset('admin/assets/examples/css/uikit/carousel.css')}}">
    <link rel="stylesheet" href="{{URL::asset('admin/assets/examples/css/uikit/dropdowns.css')}}">
@stop
...
@section('page_content')
    <div class="page">
      <div class="page-content container-fluid pb-0">
        <div class="row">
          @include('admin.property.uploadFile')
          @include('admin.property.updateState')
          <div class="col-lg-4">
            <!-- Page Widget -->
                ...
                <div class="slider" id="exampleFade">
                  @if($Documents = "")
                      @foreach($Documents as $d)
                          <div>
                            <img class="img-fluid" alt="..." data-lazy="{{URL::asset('admin/uploads/images/')}}/{{$d->name}}"/>
                          </div>
                      @endforeach
                    @else
                      <div>
                      <img src="{{URL::asset('admin/assets/images/no_disponible.jpg')}}" alt="...">
                      </div>
                    @endif
                  </div>
              </div>
                    ...
                    <ul class="list-group m-0">
                      <li class="list-group-item">
                        <header class="panel-heading">
                          <div class="panel-actions"><button type="button" onclick="window.location.href='/administrator/properties/edit/{{Crypt::encrypt($Property->id)}}'" class="btn btn-floating btn-success btn-sm"><i class="icon wb-pencil" aria-hidden="true"></i></button></div>
                        </header>
                        <div class="media">
                          <div class="media-body">
                            <div class="row">
                              <div class="col-xxl-6 col-lg-6">
                                <div class="form-group">
                                  <p class="m-0">Tipo de Oferta</p>
                                  @if($Property->typeOffer == 1)
                                  <h5 class="mt-0 mb-5">Venta</h5>
                                  @else
                                  <h5 class="mt-0 mb-5">Arriendo</h5>
                                  @endif
                              </div>
                              </div>
                              <div class="col-xxl-6 col-lg-6">
                                <div class="form-group">
                                  <p class="m-0">Tipo de Propiedad</p>
                                  <h5 class="mt-0 mb-5">{{$Property->typeProperty}}</h5>
                                </div>
                              </div>
                            </div>
                            <div class="row">
                              <div class="col-xxl-6 col-lg-6">
                                <div class="form-group">
                                  ...
                                  <h5 class="mt-0 mb-5">{{$Property->city}}</h5>
                              </div>
                              </div>
                              <div class="col-xxl-6 col-lg-6">
                                <div class="form-group">
                                  <p class="m-0">Barrio</p>
                                  <h5 class="mt-0 mb-5">{{$Property->neighborhood}}</h5>
                                </div>
                              </div>
                            </div>
                            <div class="row">
                              <div class="col-xxl-6 col-lg-6">
                                <div class="form-group">
                                  ...
                                  <h5 class="mt-0 mb-5">{{$Property->address}}</h5>
                              </div>
                              </div>
                              <div class="col-xxl-6 col-lg-6">
                                <div class="form-group">
                                  <p class="m-0">Precio</p>
                                  <h5 class="mt-0 mb-5">${{$Property->price}}</h5>
                                </div>
                              </div>
                            </div>
                        </div>
                ...
                <table class="table table-hover dataTable table-striped w-full" data-plugin="dataTable">
                  ...
                  <tbody>
                    @foreach($payment as $pay)
                      ...
                      <td>{{$pay->cutoffDate}}</td>
                      <td>{{$pay->paymentLimit}}</td>
                      @if($pay->state == false)
                      <td>Sin pagar</td>
                      @else
                      <td>Pagado</td>
                      @endif
                      @if($pay->invoiceGenerated != true)
                      <td>No Generado</td>
                      @else
                      <td>Generado</td>
                      @endif
                      <td>
                      @if($pay->invoiceGenerated != true)
                        <button onclick="propertyId({{$pay->id}})" data-target="#examplePositionCenter" data-toggle="modal" type="button" class="btn btn-raised btn-primary">Subir Documento</button>
                      @else
                      <div class="btn-group">
                          <button type="button" class="btn btn-raised btn-primary dropdown-toggle" id="exampleSizingDropdown2" data-toggle="dropdown" aria-expanded="false">Opciones</button>
                          <div class="dropdown-menu" aria-labelledby="exampleSizingDropdown2" role="menu">
                            <a class="dropdown-item" style="text-decoration: none !important;" href="/administrator/properties/download/{{Crypt::encrypt($pay->id)}}" role="menuitem">Ver Documento</a>
                            <a class="dropdown-item" onclick="propertyId({{$pay->id}})" data-target="#examplePositionCenter" data-toggle="modal" style="text-decoration: none !important;" role="menuitem">Actualizar Documento</a>
                            <a class="dropdown-item" onclick="paymentId({{$pay->id}})" data-target="#StatePayment" data-toggle="modal" style="text-decoration: none !important;" role="menuitem">Actualizar Pago</a>
                          </div>
                      </div>
                      @endif
                      </td>
...
<script src="{{URL::asset('admin/global/js/Plugin/jvectormap.js')}}"></script>
        ...
        <script src="{{URL::asset('admin/global/vendor/owl-carousel/owl.carousel.js')}}"></script>
        <script src="{{URL::asset('admin/global/vendor/slick-carousel/slick.js')}}"></script>
        <script src="{{URL::asset('admin/global/js/Plugin/owl-carousel.js')}}"></script>
        <script src="{{URL::asset('admin/assets/examples/js/uikit/carousel.js')}}"></script>
        <script src="{{URL::asset('admin/global/vendor/bootstrap-hover-dropdown/bootstrap-hover-dropdown.min.js')}}"></script>
