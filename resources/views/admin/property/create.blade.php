            ...
            <div class="card card-shadow card-responsive" id="widgetLineareaColor">
              <div class="card-block p-0">
                  ...
                  <div class="panel-heading">
                    <h3 class="panel-title">Crear Inmueble</h3>
                  </div>
                  <div class="panel-body">
                    <!-- Steps -->
                    <div class="pearls row">
                      <div class="pearl current col-4">
                        ...
                        <span class="pearl-title">Datos del Inmueble</span>
                      </div>
                      <div class="pearl col-4">
                        <div class="pearl-icon"><i class="icon wb-user" aria-hidden="true"></i></div>
                        <span class="pearl-title">Datos del Propietario</span>
                      </div>
                      <div class="pearl col-4">
                        ...
                        <div class="wizard-pane active" id="exampleAccountOne" role="tabpanel">
                          <div class="row">
                            ...
                            <div class="col-xxl-6 col-lg-6">
                              <div class="form-group">
                                <label class="form-control-label" for="inputUserNameOne">Tipo de oferta</label>
                                <select class="form-control" data-plugin="select2" name="typeOffer">
                            ...
                            <div class="col-xxl-6 col-lg-6">
                              <div class="form-group">
                                <label class="form-control-label" for="inputUserNameOne">Tipo de inmueble</label>
                                <select class="form-control" data-plugin="select2" name="typeProperty">
                          ...
                          <div class="row">
                            <div class="col-xxl-6 col-lg-6">
                              <div class="form-group">
                                <label class="form-control-label" for="inputPasswordOne">Ciudad / Municipio</label>
                                <select class="form-control" data-plugin="select2" name="city">
                            ...
                            <div class="col-xxl-6 col-lg-6">
                              <div class="form-group">
                                <label class="form-control-label" for="inputPasswordOne">Barrio</label>
                                <input type="text" class="form-control" id="inputPasswordOne" name="neighborhood" required="required">
                              </div>
                            </div>
                          </div>
                          <div class="row">
                            <div class="col-xxl-6 col-lg-6">
                              <div class="form-group">
                                <label class="form-control-label" for="inputPasswordOne">Dirección</label>
                                <input type="text" class="form-control" id="inputPasswordOne" name="address" required="required">
                              </div>
                            </div>
                            <div class="col-xxl-6 col-lg-6">
                              <div class="form-group">
                                <label class="form-control-label" for="inputPasswordOne">Precio ($)</label>
                                <input type="text" class="form-control" id="inputPasswordOne" name="price" required="required">
                              </div>
                            </div>
                          </div>
                          <div class="row">
                            <div class="col-xxl-6 col-lg-6">
                              <div class="form-group">
                                <label class="form-control-label" for="inputPasswordOne">Estrato</label>
                                <select class="form-control" data-plugin="select2" name="stratum">
                            ...
                            <div class="col-xxl-6 col-lg-6">
                              <div class="form-group">
                                <label class="form-control-label" for="inputPasswordOne">Área(m²)</label>
                                <input type="text" class="form-control" id="inputPasswordOne" name="area" required="required">
                              </div>
                            </div>
                          </div>
                          <div class="row">
                            <div class="col-xxl-6 col-lg-6">
                              <div class="form-group">
                                <label class="form-control-label" for="inputPasswordOne">Número de habitaciones</label>
                                <select class="form-control" data-plugin="select2" name="rooms">
                                      <option value="">Seleccione las habitaciones</option>
                                      <option value="1">1</option>
                                      <option value="2">2</option>
                                      <option value="3">3</option>
                                      <option value="4">4</option>
                            ...
                            <div class="col-xxl-6 col-lg-6">
                              <div class="form-group">
                                <label class="form-control-label" for="inputPasswordOne">Número de baños</label>
                                <select class="form-control" data-plugin="select2" name="bathrooms">
                                      <option value="">Seleccione los baños</option>
                                      <option value="1">1</option>
                                      <option value="2">2</option>
                                      <option value="3">3</option>
                                      <option value="4">4</option>
                          ...
                          <div class="row">
                            <div class="col-xxl-12 col-lg-12">
                              <div class="form-group">
                                <label class="form-control-label" for="inputPasswordOne">Caracteristicas</label>
                                <textarea class="form-control" placeholder="" name="characteristics"></textarea>
                              </div>
                            </div>
                          </div>
                          <label class="form-control-label" for="inputUserNameOne">Imagenes del Inmueble</label>
                          <div class="row">
                            <div class="col-xxl-4 col-lg-4">
                              <div class="example">
                                <input name="images[]" type="file" id="input-file-now" data-plugin="dropify" data-default-file="" accept=".jpg, .jpeg, .png"/>
                              </div>
                            </div>
                            <div class="col-xxl-4 col-lg-4">
                              <div class="example">
                          ...
                          <div class="row">
                            ...
                            <div class="col-xxl-6 col-lg-6">
                              <div class="form-group">
                                ...
                                <input type="text" class="form-control" id="inputPasswordOne" name="phone" required="required">
                              </div>
                            </div>
                          </div>
                          <div class="row">
                            <div class="col-xxl-6 col-lg-6">
                              <div class="form-group">
                                ...
                                <input type="text" class="form-control" id="inputPasswordOne" name="email" required="required">
                              </div>
                            </div>
                            <div class="col-xxl-6 col-lg-6">
                              <div class="form-group">
                                <label class="form-control-label" for="inputUserNameOne">Usuario</label>
                                <input type="text" class="form-control" id="inputPasswordOne" name="username" required="required">
                              </div>
                            </div>
                          </div>
                          <div class="row">
                ...
                (0, _jquery2.default)('#exampleFormContainer').formValidation({
                  ...
                  fields: {
                    typeOffer: {
                      validators: {
                        notEmpty: {
                          message: 'Seleccione tipo de oferta'
                        }
                      }
                    },typeProperty: {
                      validators: {
                        notEmpty: {
                          message: 'Seleccione tipo de inmueble'
                        }
                      }
                    },city: {
                      validators: {
                        notEmpty: {
                          message: 'Seleccione una Ciudad / Municipio'
                        }
                      }
                    },neighborhood: {
                      validators: {
                        notEmpty: {
                          message: 'Dijite el Barrio'
                        }
                      }
                    },address: {
                      validators: {
                        notEmpty: {
                          message: 'Dijite la Direccion'
                        }
                      }
                    },stratum: {
                      validators: {
                        notEmpty: {
                          message: 'Seleccione el Estrato'
                        }
                      }
                    },images: {
                        validators: {
                      ...
                      validators: {
                        notEmpty: {
                          message: 'Dijite el area'
                        }
                      }
                    },rooms: {
                      validators: {
                        notEmpty: {
                          message: 'Dijite el numero de habitaciones'
                        }
                      }
                    },bathrooms: {
                      validators: {
                        notEmpty: {
                          message: 'Dijite el numero de baños'
                        }
                      }
                    }
                    ,characteristics: {
                      validators: {
                        notEmpty: {
                          message: 'Dijite las Caracteristicas'
                        }
                      }
                    },password: {
                      validators: {
