      ...
      <div class="page-content">
        <div class="panel">
          <header class="panel-heading">
            <div class="panel-actions"><button type="button" onclick="window.location.href='/administrator/tenants/add'" class="btn btn-floating btn-success btn-sm"><i class="icon io-plus" aria-hidden="true"></i></button></div>
            <h3 class="panel-title">Arrendatarios</h3>
          </header>
          <div class="panel-body">
            <table class="table table-hover dataTable table-striped w-full" data-plugin="dataTable">
              ...
              <tbody>
                ...
                <tr>
                  ...
                  <td><button onclick="window.location.href='/administrator/tenants/profile/{{Crypt::encrypt($u->id)}}'" type="button" class="btn btn-raised btn-primary">Perfil</button></td>
                </tr>
                @endforeach
              </tbody>
            </table>
