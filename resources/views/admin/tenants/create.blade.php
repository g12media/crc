            ...
            <div class="card card-shadow card-responsive" id="widgetLineareaColor">
              <div class="card-block p-0">
                  ...
                  <div class="panel-heading">
                    <h3 class="panel-title">Crear Arrendatario</h3>
                  </div>
                  <div class="panel-body">
                    <!-- Steps -->
                    <div class="pearls row">
                      ...
                      <div class="pearl col-4">
                        ...
                        <span class="pearl-title">Inmueble</span>
                      </div>
                      <div class="pearl col-4">
                        <div class="pearl-icon"><i class="icon wb-user" aria-hidden="true"></i></div>
                      ...
                      <div class="wizard-content">
                            ...
                            <table class="table table-hover dataTable table-striped w-full" data-plugin="dataTable">
                              ...
                              <tbody>
                                ...
                                <tr>
                                  ...
                                  <td>{{$p->price}}</td>
                                  <td><button onclick="property({{$p->id}})" type="button" class="btn btn-raised btn-primary">Seleccionar</button></td>
                                </tr>
                                @endforeach
                              </tbody>
                            </table>
                        ...
                        <div class="wizard-pane" id="exampleBillingTwo" role="tabpanel">
                          <div class="text-center my-20">
                            ...
                            <input type="text" name="idProperty" id="idProperty" hidden=""/>
...
<script src="{{URL::asset('admin/global/vendor/formvalidation/formValidation.js')}}"></script>
        ...
        function property(Id) {
          ...
          $.get( "/administrator/tenants/property/"+Id).done(function(data) {
