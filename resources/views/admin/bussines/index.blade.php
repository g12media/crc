      ...
      <div class="page-content">
        <div class="panel">
          <header class="panel-heading">
            <div class="panel-actions"><button type="button" onclick="window.location.href='/administrator/bussines/add'" class="btn btn-floating btn-success btn-sm"><i class="icon io-plus" aria-hidden="true"></i></button></div>
          ...
          <div class="panel-body">
            <table class="table table-hover dataTable table-striped w-full" data-plugin="dataTable">
              ...
              <tbody>
                ...
                <tr>
                  <td>{{$b->typeBussines}}</td>
                  <td>{{$b->name}}</td>
                  <td>{{$b->description}}</td>
                  <td>{{$b->price}}</td>
                  <td><button onclick="window.location.href='/administrator/properties/profile/{{Crypt::encrypt($b->id)}}'" type="button" class="btn btn-raised btn-primary">Edit</button></td>
                </tr>
                @endforeach
              </tbody>
            </table>
