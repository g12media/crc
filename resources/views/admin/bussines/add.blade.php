                      ...
                      <div class="wizard-content">
                        <div class="wizard-pane active" id="exampleAccountOne" role="tabpanel">
                          <div class="row">
                            ...
                            <div class="col-xxl-12 col-lg-12">
                              <div class="form-group">
                                <label class="form-control-label" for="inputUserNameOne">Tipo de Negocio</label>
                                <select class="form-control" data-plugin="select2" name="typeBussines">
                                      <option value="">Seleccione tipo de Negocio</option>
                                      <option value="avaluo">Avaluo</option>
                                      <option value="Derechos Contrato">Derechos de Contrato</option>
                                      <option value="Asesoria Juridica">Asesoria Juridica</option>
                                      <option value="Mantenimiento">Mantenimiento</option>
                                      <option value="Centros Conciliación">Centros de Conciliación</option>
                                      <option value="Alianzas Estrategicas">Alianzas Estrategicas</option>
                                      <option value="Prestamos Hipotecarios">Prestamos Hipotecarios</option>
                                  </select>
                              </div>
                            </div>
                          </div>
                          <div class="row">
                            <div class="col-xxl-6 col-lg-6">
                              <div class="form-group">
                                <label class="form-control-label" for="inputUserNameOne">Nombre</label>
                                <input type="text" class="form-control" id="inputPasswordOne" name="name" placeholder="Nombre negociante" required="required">
                              </div>
                            </div>
                            <div class="col-xxl-6 col-lg-6">
                              <div class="form-group">
                                <label class="form-control-label" for="inputUserNameOne">Valor del negocio</label>
                                <input type="text" class="form-control" id="inputPasswordOne" name="price" placeholder="$ 0'000.000" required="required">
                              </div>
                            </div>
                          </div>
                          <div class="row">
